    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <p className="text-marca-tenue text-[11px] flex items-start gap-1.5">
          ...
          Tus fotos publicadas en Historias, aquí las tienes hasta por 7 días — se borran solas después (aunque
          en "Historias del equipo" ya dejan de verse a las 24 horas).
        </p>
